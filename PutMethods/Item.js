...
const gatewayMap = {
    ...
    '/Update': { host: 'localhost', port: 5010, path: '/api/Item/Update' },

    '/Delete': { host: 'localhost', port: 5010, path: '/api/Item/Delete' },
    
    '/ChangeItemQualityType': { host: 'localhost', port: 5010, path: '/api/Item/ChangeItemQualityType' },
